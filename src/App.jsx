...
import NotFoundRoot from "./pages/not-found-root";
...
function AppRouter() {
  const mainRoutes = [
    ...
    "/dashboard/user/property-bought",
    ...
    "/dashboard/agent/sold-properties",
    "/dashboard/agent/requested-properties",
    "/dashboard/admin/profile",
    "/dashboard/admin/manage-properties",
    "/dashboard/admin/manage-users",
    "/dashboard/admin/manage-reviews",
    "/dashboard/admin/advertise-property"
  ];
    ...
    <Routes>
      ...
      <Route
        ...
        element={
          ...
          window.location.pathname.startsWith("/all-properties") ||
          window.location.pathname.startsWith("/make-offer") ||
